...
<div class="container  mx-auto bg-white max-w-screen-lg p-8 rounded-lg relative">
	...
	<p>
		...
		hohen Stellenwert für die Geschäftsleitung der tagungshotels.info UG (haftungsbeschränkt). Eine
		Nutzung der Internetseiten der tagungshotels.info UG (haftungsbeschränkt) ist grundsätzlich ohne
	...
	<ul style="list-style: none">
		...
		<li>
			...
			<p>
				...
				personenbezogenen Daten, die bei der tagungshotels.info UG (haftungsbeschränkt) gespeichert
				sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
				Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der tagungshotels.info UG
				(haftungsbeschränkt) wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
				wird.
			</p>
			...
			<p>
				...
				Mitarbeiter der tagungshotels.info UG (haftungsbeschränkt) wird im Einzelfall das Notwendige
				veranlassen.
			</p>
		</li>
		<li>
		...
		<li>
			...
			<p>
				...
				von einem Verantwortlichen an einen anderen Verantwortlichen übermittelt werden, soweit dies
		...
		<li>
			...
			<p>
				...
				für die Verarbeitung nachweisen, die den Interessen, Rechten und Freiheiten der betroffenen
			...
			<p>
				...
				Widerspricht die betroffene Person gegenüber der tagungshotels.info UG (haftungsbeschränkt)
				der Verarbeitung für Zwecke der Direktwerbung, so wird die tagungshotels.info UG
				(haftungsbeschränkt) die personenbezogenen Daten nicht mehr für diese Zwecke verarbeiten.
			</p>
