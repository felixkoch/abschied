...
<div class="container  mx-auto max-w-screen-lg">
	<div class="mx-4 bg-white p-8 rounded-lg relative">
		<h1>Datenschutzerklärung</h1>

		<p>
			Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat einen besonders
			hohen Stellenwert für die Geschäftsleitung der tagungshotels.info UG (haftungsbeschränkt).
			Eine Nutzung der Internetseiten der tagungshotels.info UG (haftungsbeschränkt) ist
		...
		<p>
			...
			Datenschutz-Grundverordnung und in Übereinstimmung mit den für die tagungshotels.info UG
		...
		<p>
			Die tagungshotels.info UG (haftungsbeschränkt) hat als für die Verarbeitung Verantwortlicher
		...
		<p>
			Die Datenschutzerklärung der tagungshotels.info UG (haftungsbeschränkt) beruht auf den
			Begrifflichkeiten, die durch den Europäischen Richtlinien- und Verordnungsgeber beim Erlass
			der Datenschutz-Grundverordnung (DS-GVO) verwendet wurden. Unsere Datenschutzerklärung soll
			sowohl für die Öffentlichkeit als auch für unsere Kunden und Geschäftspartner einfach lesbar
		...
		<p>
			Die Internetseite der tagungshotels.info UG (haftungsbeschränkt) erfasst mit jedem Aufruf der
			...
			von welcher ein zugreifendes System auf unsere Internetseite gelangt (sogenannte Referrer),
			(4) die Unterwebseiten, welche über ein zugreifendes System auf unserer Internetseite
			angesteuert werden, (5) das Datum und die Uhrzeit eines Zugriffs auf die Internetseite, (6)
			eine Internet-Protokoll-Adresse (IP-Adresse), (7) der Internet-Service-Provider des
		...
		<p>
			Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die tagungshotels.info UG
			...
			erhobenen Daten und Informationen werden durch die tagungshotels.info UG (haftungsbeschränkt)
		...
		<ul style="list-style: none">
			...
			<li>
				...
				<p>
					...
					von personenbezogenen Daten, die bei der tagungshotels.info UG (haftungsbeschränkt)
					gespeichert sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter
					des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der tagungshotels.info
					UG (haftungsbeschränkt) wird veranlassen, dass dem Löschverlangen unverzüglich
					nachgekommen wird.
				</p>

				<p>
					Wurden die personenbezogenen Daten von der tagungshotels.info UG (haftungsbeschränkt)
					...
					tagungshotels.info UG (haftungsbeschränkt) unter Berücksichtigung der verfügbaren
					...
					dieser personenbezogenen Daten verlangt hat, soweit die Verarbeitung nicht erforderlich
					ist. Der Mitarbeiter der tagungshotels.info UG (haftungsbeschränkt) wird im Einzelfall das
			...
			<li>
				...
				<p>
					...
					Einschränkung von personenbezogenen Daten, die bei der tagungshotels.info UG
					(haftungsbeschränkt) gespeichert sind, verlangen möchte, kann sie sich hierzu jederzeit an
					einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
					tagungshotels.info UG (haftungsbeschränkt) wird die Einschränkung der Verarbeitung
					veranlassen.
				</p>
			</li>
			<li>
				...
				<p>
					...
					jederzeit an einen Mitarbeiter der tagungshotels.info UG (haftungsbeschränkt) wenden.
				</p>
			</li>
			<li>
				...
				<p>
					Die tagungshotels.info UG (haftungsbeschränkt) verarbeitet die personenbezogenen Daten im
					Falle des Widerspruchs nicht mehr, es sei denn, wir können zwingende schutzwürdige Gründe
				...
				<p>
					Verarbeitet die tagungshotels.info UG (haftungsbeschränkt) personenbezogene Daten, um
					...
					Verbindung steht. Widerspricht die betroffene Person gegenüber der tagungshotels.info UG
					(haftungsbeschränkt) der Verarbeitung für Zwecke der Direktwerbung, so wird die
					tagungshotels.info UG (haftungsbeschränkt) die personenbezogenen Daten nicht mehr für
				...
				<p>
					...
					der tagungshotels.info UG (haftungsbeschränkt) zu wissenschaftlichen oder historischen
				...
				<p>
					...
					Mitarbeiter der tagungshotels.info UG (haftungsbeschränkt) oder einen anderen Mitarbeiter
					wenden. Der betroffenen Person steht es ferner frei, im Zusammenhang mit der Nutzung von
			...
			<li>
				...
				<p>
					...
					ausdrücklicher Einwilligung der betroffenen Person, trifft die tagungshotels.info UG
					(haftungsbeschränkt) angemessene Maßnahmen, um die Rechte und Freiheiten sowie die
